       ...
       >
        <Modal.Header closeButton  variant="primary" className="Modal-Info">
          <Modal.Title id="example-custom-modal-styling-title" className="Modal-Info">
            Photo hari ini <img src={astronautHeader}></img>
          </Modal.Title>
        </Modal.Header>
        <Modal.Body className="Modal-Info">
          <p className="Modal-Info">
            Bagian ini menunjukkan sevbuah gambar atau video atau informasi yang berhubungan dengan gambar astronomy pada hari ini. (setiap hari gambar ini akan update!)
          </p>
        </Modal.Body>
      </Modal>
